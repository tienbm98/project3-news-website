...
class FrontController extends Controller
{
    public function index()
    {
        ...
        $newscategory_one   = News::latest()->whereHas('category')->where('category_id',6)->where('status',1)->take(5)->get();
        $newscategory_two   = News::latest()->whereHas('category')->where('category_id',7)->where('status',1)->take(5)->get();
        $newscategory_three = News::latest()->whereHas('category')->where('category_id',4)->where('status',1)->take(5)->get();
    ...
    public function pageCategory($slug)
    {
        ...
        $featurednewslist   = $category->newslist()->where('status',1)->where('featured',1)->get();
